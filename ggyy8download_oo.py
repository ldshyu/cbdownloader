...
if __name__ == '__main__':
    # for full download
#	book_url = 'http://www.ggyy8.cc/html/info84689.html'
#	book_name = 'Wolf'
...
#for multiple episode download
	book_url = 'http://www.ggyy8.cc/html/info84585.html'
	book_name = '海賊王'
	cb = comic_books(book_url, book_name)
	cb.download_chapters(713, 729)
	cb.endbook()

#    book_url = 'http://www.iggyy8.com/html/info84585/298959.html'
#    book_name = '海賊王729話'
#    chap = chapters(book_url, book_name)
#    chap.get_imagelist()
#    chap.download()


#	book_url = 'http://www.ggyy8.cc/html/info179262.html'
#	book_name = '名偵探柯南'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(871, 874)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info84634.html'
#	book_name = '境界的輪迴'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(202)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info153733.html'
#	book_name = '烏龍派出所'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(129,133)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info84861.html'
#	book_name = 'Sket Dance'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(all=True)
#	cb.endbook()

#    book_url = 'http://www.iggyy8.com/html/info85067.html'
#    book_name = '妖精的尾巴'
#    cb = comic_books(book_url, book_name)
#    cb.download_chapters(all=True)
#    cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info157292.html'
#	book_name = '魔王奶爸'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(230)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info146492.html'
#	book_name = '金田一'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(all=True)
#	cb.endbook()

#    book_url = 'http://www.ggyy8.cc/html/info84720.html'
#    book_name = '某科學的超電磁炮'
#    cb = comic_books(book_url, book_name)
#    cb.download_chapters(all=True)
#    cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info166831.html'
#	book_name = 'xxxHOLiC·戻'
#	cb = comic_books(book_url, book_name, quiet=True)
#	cb.download_chapters(all=True)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info84741.html'
#	book_name = '魔法禁書目錄'
#	cb = comic_books(book_url, book_name, quiet=True)
#	cb.download_chapters(all=True)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info166699.html'
#	book_name = '魔法禁書目錄恩底彌翁的奇蹟'
#	cb = comic_books(book_url, book_name, quiet=True)
#	cb.download_chapters(all=True)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info137625.html'
#	book_name = '我家賣A書的'
#	cb = comic_books(book_url, book_name, quiet=True)
#	cb.download_chapters(all=True)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info84696.html'
#	book_name = '龍虎鬥'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(all=True)
#	cb.endbook()
