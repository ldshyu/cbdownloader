...
#	book_name = '海賊王'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(685,685)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info84722.html'
#	book_name = '名偵探柯南'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(833,836)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info84634.html'
#	book_name = '境界的輪迴'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(166,166)
#	cb.endbook()

#	book_url = 'http://www.ggyy8.cc/html/info153733.html'
#	book_name = '烏龍派出所'
#	cb = comic_books(book_url, book_name)
#	cb.download_chapters(126,129)
#	cb.endbook()
